###LCX20250801修改第76行：face_alignment.LandmarksType._2D，修改为：.TWO_D
...
class EuclLmkDistance(Metric):
    ...
    def __init__(self, device='cuda'):
        ...
        self.fa = face_alignment.FaceAlignment(face_alignment.LandmarksType.TWO_D, ###LCX修改face_alignment.LandmarksType._2D 为: .TWO_D
                                               flip_input=False,
                                               device=device)
